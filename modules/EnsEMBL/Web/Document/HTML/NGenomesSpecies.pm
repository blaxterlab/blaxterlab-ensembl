...
sub render_species_list {
  ...
  if (@ok_faves){
    ...
    $html = qq{<div class="static_favourite_species"><h3 class="lb-heading">ngenomes Ensembl genome browser - select a species/assembly to begin</h3><div class="species_list_container species-list">$fav_html</div></div>};
  }
